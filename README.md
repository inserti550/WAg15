...
# WAg15
**WAg15** - Winamp plugin that allows you to control the player using soft buttons and view player statistics on the LCD screen
...
2. Display elapsed and total song time
3. Progress bar
4. Settings menu
5. Control for winamp
6. Realtime preview
